export const countryOptions = [
  ...
  { code: 'AG', name: 'Antigua & Barbuda', phoneCode: '+1-268' },
  { code: 'AR', name: 'Argentina', phoneCode: '+54' },
  { code: 'AM', name: 'Armenia', phoneCode: '+374' },
  { code: 'AW', name: 'Aruba', phoneCode: '+297' },
  { code: 'AC', name: 'Ascension Island', phoneCode: '+247' },
  ...
  { code: 'BA', name: 'Bosnia & Herzegovina', phoneCode: '+387' },
  ...
  { code: 'CG', name: 'Congo - Brazzaville', phoneCode: '+242' },
  { code: 'CD', name: 'Congo - Kinshasa', phoneCode: '+243' },
  ...
  { code: 'HK', name: 'Hong Kong SAR China', phoneCode: '+852' },
  ...
  { code: 'MO', name: 'Macao SAR China', phoneCode: '+853' },
  ...
  { code: 'MM', name: 'Myanmar (Burma)', phoneCode: '+95' },
  ...
  { code: 'PS', name: 'Palestinian Territories', phoneCode: '+970' },
  ...
  { code: 'SH', name: 'St. Helena', phoneCode: '+290' },
  { code: 'KN', name: 'St. Kitts & Nevis', phoneCode: '+1-869' },
  { code: 'LC', name: 'St. Lucia', phoneCode: '+1-758' },
  { code: 'MF', name: 'St. Martin', phoneCode: '+590' },
  { code: 'PM', name: 'St. Pierre & Miquelon', phoneCode: '+508' },
  { code: 'VC', name: 'St. Vincent & Grenadines', phoneCode: '+1-784' },
  { code: 'SD', name: 'Sudan', phoneCode: '+249' },
  { code: 'SR', name: 'Suriname', phoneCode: '+597' },
  { code: 'SJ', name: 'Svalbard & Jan Mayen', phoneCode: '+47' },
  ...
  { code: 'TT', name: 'Trinidad & Tobago', phoneCode: '+1-868' },
  { code: 'TA', name: 'Tristan da Cunha', phoneCode: '+290' },
  { code: 'TN', name: 'Tunisia', phoneCode: '+216' },
  { code: 'TR', name: 'Turkey', phoneCode: '+90' },
  { code: 'TM', name: 'Turkmenistan', phoneCode: '+993' },
  { code: 'TC', name: 'Turks & Caicos Islands', phoneCode: '+1-649' },
  ...
  { code: 'WF', name: 'Wallis & Futuna', phoneCode: '+681' },
