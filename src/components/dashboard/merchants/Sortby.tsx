  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className='w-[194px] text-sm font-medium text-secondary'>
        <DropdownMenuSub>
          <DropdownMenuSubTrigger className='cursor-pointer'>Merchant Name</DropdownMenuSubTrigger>
          <DropdownMenuPortal>
            <DropdownMenuSubContent>
              <DropdownMenuItem
                onSelect={() => handleSort('merchant_name', 'asc')}
                className={cn(
                  'gap-2 cursor-pointer',
                  selectedSort?.column === 'merchant_name' &&
              ...
              <DropdownMenuItem
                onSelect={() => handleSort('merchant_name', 'desc')}
                className={cn(
                  'gap-2 cursor-pointer',
                  selectedSort?.column === 'merchant_name' &&
