  ...
  return `
    <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen-Sans,Ubuntu,Cantarell,'Helvetica Neue',sans-serif;">
      <div style="margin: 0 auto; padding: 20px 0 48px;">
        ...
        <p style="font-size: 16px; line-height: 26px;">Welcome to Camino, your one-stop solution for building SaaS applications.</p>
        <div style="width: 100%; text-align: center;">
          <a href='${config.app.url}' style="background-color: #5F51E8; border-radius: 6px; color: #fff; font-size: 16px; text-decoration: none; text-align: center; display: block; width: 100%; padding: 12px 0; margin-top: 10px;">
            Get started
          </a>
        </div>
